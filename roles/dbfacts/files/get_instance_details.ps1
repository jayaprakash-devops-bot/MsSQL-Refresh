        ...
        ForEach ($Computer in $Computername) {
            ...
            If ($instances.count -gt 0) {
                ForEach ($Instance in $Instances) {
                    ...
                    $object.FullName = $Object.FullName.Replace('\MSSQLSERVER','')
                    $Object | Select-object -ExpandProperty FullName |ConvertTo-Json -Compress
                }#FOREACH INSTANCE
            }#IF
        }
    }
...
$env:COMPUTERNAME | Get-SQLInstance
